...
btn1.addEventListener(
  ...
  function () {
    ...
    // n = 0;
    // console.log(resultText.length"大吉");
    btn1.textContent = resultText[n];
    btn1.style.color = resultColor[n];
    btn1.style.fontSize = resultFontSize[n];

    // btn1.style.transform = "1s";
    // btn1.style.resultMaxSpeed = [n];
    // btn1.style.resultMaxSize =[n];
    // btn1.style.resultImage =[n];
    ...
    $(document).ready(function () {
      $(document).snowfall({
        ...
        minSize: 1, // 最小サイズ
        image: resultImage[n]    // image : 'img/sakura_hanabira.png'
      });
    });
  },
  false
